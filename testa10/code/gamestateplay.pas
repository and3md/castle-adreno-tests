...
begin
  ...
  //WritelnLog('Direction ' + MainViewport.Camera.Direction.ToString);
  //WritelnLog('Position ' + MainViewport.Camera.Position.ToString);
end;
...
procedure TStatePlay.ClickButton(Sender: TObject);
begin
  {MainViewport.Camera.Position := Vector3(0.97,0.00,0.26);
  MainViewport.Camera.Direction := Vector3(-0.30, 1.82, -2.66);}

  MainViewport.Camera.Position := Vector3(1.95, 1.48, -1.94);
  MainViewport.Camera.Direction := Vector3(0.95, 0.00, 0.31);

  MainViewport.Camera.Position := Vector3(1.92, 1.48, -1.95);
  MainViewport.Camera.Direction := Vector3(0.95, 0.00, 0.30);
end;
